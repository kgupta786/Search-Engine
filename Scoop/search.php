...
<div class="container-fluid">
    ...
    <div class="row" style="min-height: 130px; background-color: #f2f2f2;border:none">
        ...
        <input type="text" style="width: 600px;margin-top: 40px;margin-left: 30px;border-bottom: groove"  name="tbfirst" value="<?php  echo $_SESSION["query"] ?>" class="form-control" id="name">
        </div>
        </div>
        <div class="row">
            <div class="col-sm-2" style="min-height: 1050px;background-color: #f2f2f2">
                ...
                <table class="table table-striped table-hover" style="height: 300px">
                    ...
                    <tr>
                        <td><a href=""><span style="margin-left: 25%;text-align: justify"><?php

                                    echo $_SESSION["email"]?></span></a> </td>
                    </tr>
